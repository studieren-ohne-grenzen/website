  ...
  <nav class="container">
    <ul class="menu-list relative">
      ...
      <li
        ...
        :key="item"
        class="flex-none pb-4 mr-6 xl:mr-10 hover:text-sogblue-dark transition-colors duration-100"
      >
        <nuxt-link
          :to="localePath(`/${index}`)"
      ...
      <li class="flex-none flex">
        ...
        >
          <li
            ...
            :key="locale.code"
            class="flex hover:text-sogblue-dark transition-colors duration-100"
          >
            <svg
